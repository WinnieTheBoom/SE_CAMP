                        ...
                        <form action="/titles" method="post">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tit_name" class="form-cont" 
                                        placeholder="เช่น นาย นาง นางสาว ฯลฯ">
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" name="tit_is_active" checked id="exampleCheck1">
                                    <label class="form-check-label" for="exampleCheck1">บันทึก</label>
                                </div>
                            </div>
                            <!-- /.card-body -->
